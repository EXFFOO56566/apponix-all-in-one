...
import com.tochy.browser.Tochy.VideoPlayer;
import com.tochy.browser.Tochy.utils.TouchImageView;
...
public class ShowAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NotNull ViewGroup container, final int position) {
        ...
        imageView_play.setOnClickListener(v -> activity.startActivity(new Intent(activity, VideoPlayer.class)
