...
//
    ...
    public pictureBrowserFragment(ArrayList<pictureFacer> allImages, int imagePosition) {
        this.allImages = allImages;
        this.position = imagePosition;

    }

    public static pictureBrowserFragment newInstance(ArrayList<pictureFacer> allImages, int imagePosition) {
        pictureBrowserFragment fragment = new pictureBrowserFragment(allImages, imagePosition);
        return fragment;
    }
