...
import com.tochy.browser.databinding.ActivityMyVideoBinding;

import java.util.ArrayList;

public class MyVideoActivity extends AppCompatActivity implements itemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(MyVideoActivity.this,
        ...
        if (folds.isEmpty()) {
            ...
            RecyclerView.Adapter folderAdapter = new pictureFolderAdapter(folds, MyVideoActivity.this, this);
...
//
    ...
    public void onPicClicked(String pictureFolderPath, String folderName) {
        Intent move = new Intent(MyVideoActivity.this, VideoListFolderActivity.class);
